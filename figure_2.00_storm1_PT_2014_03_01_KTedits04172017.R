...
#1. ORIGINAL FIGRUE 2
#Overall Panel Plots of everything - Updated TJE Naval Stage
...
lines(atm.corr.interp$x, adj2.atm.corr.tje.naval, type = "l", col="green") #adjusted tje.naval NEW
...
#2. UPDATED Figure 2!! Use in EVENTS REPORT
...
#write.csv(data, file="C:/Users/Napoleon/Documents/TRW/R/PT_Script_data_used_in_script_07122016/processed_data/20140301_discharge_timeseries.csv",row.names=F)
...
fpathcsv = paste(dir, "/", "summary_20140301_observed_q.csv", sep="")
...
fpathcsv2 = paste(dir, "/", "summary_20140301_observed_q_PT_IBWC.csv", sep="")
...
#names(main)<- c("DATE", 
                ...
                #"CONVEYANCE","F.SLOPE","HEAD","FROUDE","BEDSHEAR") #may need to change, depending on which variables are selected for the output
