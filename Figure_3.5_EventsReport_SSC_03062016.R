...
setwd(dir)
evt.script = "figure_2.11_storm6_PT_2016_03b_KTedits04172017.R"
evt.script.dir = paste(dir, "/GitHub/", evt.script, sep= "") #path for event script


###############################################################################################################

#Run the events report script for storm 1 (figure_2.11_storm6_PT_2016_03b_KTedits04172017.R) to get the appropriate Q, stage, etc.
